    ...
    <div className="flex flex-col md:flex-row p-3 border border-teal-600 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center">
      <div className="flex-1 justify-center flex flex-col p-3 w-full md:w-3/5">
        <h2 className="text-2xl font-semibold text-wrap">
          ...
          <span className="text-red-600">10 BEST</span> scholarship news?
        </h2>

        <p className="text-gray-500 my-2">Check out the main article below!</p>
        ...
        <Button className="bg-blue-500 text-md mt-2 h-min">
          <Link
            ...
            className="text-wrap"
          >
            Stay Updated with Daily Scholarship News: Your Source of Information
          </Link>
        </Button>
      </div>
      ...
      <div className="p-7 w-full md:w-2/5">
        <img
          src="https://fakultas.co.id/wp-content/uploads/2024/06/tips-beasiswa-kuliah-2024.jpg"
          alt=""
          className="w-full"
        />
      </div>
